...
<h3>Campus : <?php echo $camp_name; ?>  
	...
	?>
      <tr>
        ...
        AND teacher_att.course_id=prog_courses.id AND DATE_FORMAT(teacher_att.arrival, '%m')='$month' and 
                                  DATE_FORMAT(teacher_att.arrival, '%Y')='$year' AND teacher_att.campus_id='$campus_id' GROUP BY teacher_att.course_id ") 
        or die(mysqli_error($con));
...
<td style="color:#00f"><?php 
        ...
        AND  DATE_FORMAT(teacher_att.arrival, '%m')='$month' and
                                  DATE_FORMAT(teacher_att.arrival, '%Y')='$year' AND teacher_att.campus_id='$campus_id'")  or die(mysqli_error($con));
