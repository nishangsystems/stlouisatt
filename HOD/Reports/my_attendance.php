 ...
 <a href="../SuperAdmin/Reports/print_att.php?tid=<?php echo $user_id; ?>&camp_id=<?php echo $campus_id; ?>&&name=<?php echo $_GET['name']; ?>&year_id=<?php echo $year_id; ?>&sem_id=<?php echo $sem_id; ?>&hdhdh" target="_new" class="btn btn-primary btn-xs">Print a Copy</a>
 <?php
