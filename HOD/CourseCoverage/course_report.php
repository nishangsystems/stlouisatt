				...
				<form method="POST" action="?view_logbook&link=View Logbook and Teaching Records" enctype="multipart/form-data">
                    ...
                    <select name="ayear" id="countries-list" class="form-control">
                            <option ></option>
                            <?php
