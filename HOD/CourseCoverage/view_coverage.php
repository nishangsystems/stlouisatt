	...
	?>
      ...
      <tr>
        <td><?php echo $i++; ?></td>
         ...
         <td>
  <a target="_new" href="?this_course&id=<?php echo $rows['id'] ?>&sem=<?php echo $sem_id; ?>&prog_id=<?php echo $prog_id; ?>&level_id=<?php echo $level_id; ?>&year_id=<?php echo $year_id; ?>&camp_id=<?php echo $campus_id; ?>&gdgdg"><?php echo $rows['course_title']; ?> / <?php echo $rows['course_code']; ?></a> </td>
