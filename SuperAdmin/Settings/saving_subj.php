...
<link rel="stylesheet" href="../assets/css/bootstrap.min.css" />
    ...
    <?php
     ...
     $practicals_hours="";
        if(isset($_GET['edit'])){
            $check=$con->query("SELECT * FROM  courses,prog_courses WHERE  prog_courses.id='".$_GET['edit']."'
          ...
          <div class="well">
           <form role="form" method="post" action="">
              ...
              <div class="form-group">
                ...
                <?php
                    $checkm=$con->query("SELECT * FROM courses ORDER BY course_title ") 
                    or die(mysqli_error($con));
                    
                    while($row=$checkm->fetch_assoc()){
                        ?>
                
                  <option value="<?php echo $row['id']; ?>"><?php echo $row['course_title']; ?> (<?php echo $row['course_code']; ?> )</option>
                    <?php } ?>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="tutorials" required="required" value="<?php echo $lecture_hours; ?>" 
                 class="form-control" id="pwd" onBlur="doCalc(this.form)"  style="color:#00F">
              </div>
