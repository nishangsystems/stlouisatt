						...
						<form method="POST" action="" class="form-horizontal" role="form">
					       	...
					       	<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="abb"  max="3"  id="form-field-1"   class="col-xs-10 col-sm-5" />
										</div>
									</div>
                         ...
                         <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php
							$select =$con->query("SELECT * FROM  programs WHERE degree_id='".$_GET['id']."'
							AND campus_id='".$_GET['camp_id']."' order by id DESC  ") or die(mysqli_error($con));
							$a=1;	
							while($rows=$select->fetch_assoc()){
							?>
                              <tr>
