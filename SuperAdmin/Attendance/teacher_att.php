...
WHERE  teacher_courses.id='".$_GET['course']."' 
...
Recording <Span style="color:#f00"><?php echo $teacher=$rows['full_name']; ?></span> Attendance for  <?php echo $rows['course_title'];  ?>  in  <?php echo $rows['camp_name'];  ?> Campus for <?php echo $cur_ayear;  ?> Academic Year 
 ...
 <div class="row">
		...
		<?php } ?>
              ...
              <div class="checkbox">
				<button type="submit" class="btn btn-primary" name="save">Submit Arrival</button>
 ...
 SELECT * FROM  courses,users,programs,levels,prog_courses,teacher_courses,teacher_att 
WHERE   teacher_att.teacher_id='$teacher_id'  AND teacher_att.year_id='$year_id' 
and  courses.id=prog_courses.course_id 
