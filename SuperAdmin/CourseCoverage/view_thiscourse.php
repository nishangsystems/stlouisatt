 ...
 ?> </h2>     
  <a href="../SuperAdmin/Reports/print_logbook.php?course_id=<?php echo $_GET['course_id']; ?>&year_id=<?php echo $year_id; ?>&link=<?php echo $_GET['link']; ?>&gdgdg" target="_new" class="btn btn-primary btn-xs">Print a Copy</a>
