	...
	?>
      <tr>
        ...
        ?></td>
          ...
          <td>
              <a href="?attendance&course=<?php echo $rows['course_id']; ?>&campus_id=<?php echo $rows['campus_id']; ?>&nsiahnsnsg" class="btn btn-success btn-xs">Take Attendance</a>
              <a href="?sign_logbook&id=<?php echo $rows['course_id']; ?>&campus_id=<?php echo $rows['campus_id']; ?>&gdgdhdh " class=" btn-primary btn-sm">Sign Log Book  </a>
              <a href="?course_content&campus_id=<?php echo $rows['campus_id']; ?>&id=<?php echo $rows['course_id']; ?>&link=Course content for <?php echo $title; ?> ( <?php echo $code; ?> )&gdgdhdh " class=" btn-info btn-sm">Course Content  </a>
