	...
	?>
      <tr>
        ...
        ?></td>
          ...
          <td>
              <a href="?my_attendance&course=<?php echo $rows['course_id']; ?>&nsiahnsnsg" class="btn btn-success btn-xs">My  Attendance</a>
              <a href="?my_logbook&id=<?php echo $rows['course_id']; ?>&gdgdhdh " class=" btn-primary btn-sm">Log Book Filling   </a>
